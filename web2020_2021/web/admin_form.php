		...
		<div class="container">
			<div class= "row"> 
				<ul id ="admin_tabs" class="nav nav-pills ">
					...
					<li><a data-toggle="pill" href="#m1">Ανάλυση χρόνων απόκρισης σε αιτήσεις</a></li>
					<li><a data-toggle="pill" href="#m2">Ανάλυση κεφαλίδων HTTP</a></li>
					<li><a data-toggle="pill" href="#m3">Οπτικοποίηση δεδομένων</a></li>
				</ul>
